...
test_is_valid=TestIsValidPath()
test_is_valid.test_basic_col()
test_is_valid.test_basic_diag_1()
test_is_valid.test_basic_row()
test_is_valid.test_changed_direction()
test_is_valid.test_multi_letter_cells()
test_is_valid.test_empty_path()
test_is_valid.test_negative_coordinates()
test_is_valid.test_not_adjacent_coordinates()
test_is_valid.test_one_letter_in_dict()
test_is_valid.test_path_exits_board()
test_is_valid.test_path_starts_outside_board()
test_is_valid.test_path_exits_board()
test_is_valid.test_same_point_twice_in_path()
test_is_valid.test_valid_path_word_longer_than_in_dict()
test_is_valid.test_valid_path_word_shorter_than_in_dict()
test_is_valid.test_valid_path_word_not_in_dict()
test_is_valid.test_one_letter_not_in_dict()
# noinspection Duplicates
class TestFindWords:
    ...
    def test_basic_rows(self):
        ...
        expected = [[(0, 0), (0, 1), (0, 2)],
                    [(1, 0), (1, 1), (1, 2)],
                    [(2, 0), (2, 1), (2, 2)]]
        assert [[(0, 0), (0, 1), (0, 2)], [(1, 0), (1, 1), (1, 2)], [(2, 0), (2, 1), (2, 2)]]==expected
    ...
    def test_single_letter_word(self):
        ...
        expected = [[(1, 0)], [(1, 1)], [(1, 2)]]
        actual=find_length_n_paths(1, board, word_dict)
...
test_find_words=TestFindWords()
test_find_words.test_palindrome()
test_find_words.test_single_letter_word()
test_find_words.test_multi_letter_cells()